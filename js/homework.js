...
const moviePersonalRating = prompt('На сколько оцените его?','');
personalMovieDB.movies[lastWatchedMovie] = moviePersonalRating;
}

for (let key in personalMovieDB.movies) {
    console.log(key);
    console.log(personalMovieDB.movies[key]);
}
...
personalMovieDB.count < 10?console.log("Просмотрено довольно мало фильмов"):personalMovieDB.count < 30?console.log("Вы классический зритель"):personalMovieDB.count >= 30?console.log("Вы киноман"):console.log("Произошла ошибка");
...
function writeYourGenres(){
    for (let i = 1; i <= 3; i++){
        ...
        personalMovieDB.genres.push(genreReq);
